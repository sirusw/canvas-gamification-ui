...
export class ParsonsViewSnippetComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.submissionAnalyticsService.getParsonsSubmissionAnalyticsByQuestion(this.questionId).subscribe(
            submissionAnalytics => {
        ...
        this.questionAnalyticsService.getParsonsQuestionAnalyticsByQuestion(this.questionId).subscribe(
