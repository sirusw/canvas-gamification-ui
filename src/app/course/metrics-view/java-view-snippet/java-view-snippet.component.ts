...
export class JavaViewSnippetComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.submissionAnalyticsService.getJavaSubmissionAnalyticsByQuestion(this.questionId).subscribe(
            submissionAnalytics => {
        ...
        this.questionAnalyticsService.getJavaQuestionAnalyticsByQuestion(this.questionId).subscribe(
